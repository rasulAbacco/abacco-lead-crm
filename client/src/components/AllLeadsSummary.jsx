      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 ml-14">
            Track and monitor your lead generation performance
          </p>
        </div>
          ...
          <div className="relative z-10">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div className="flex-1">
                ...
                <h2 className="text-7xl font-extrabold text-white mb-4">
                  {leads.total}
                </h2>
            ...
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div
                    className={`px-3 py-1 rounded-full bg-gradient-to-r ${stat.color} text-white text-xs font-semibold opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                  >
                    Active
                  </div>
                </div>
              ...
              <div
                className={`h-1 bg-gradient-to-r ${stat.color} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left`}
              ></div>
            </div>
          ))}
        </div>

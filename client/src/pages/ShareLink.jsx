...
const ShareLink = () => {
    ...
    try {
      ...
      alert(
        err.response?.data?.message ||
          err.message ||
          "Failed to share links. Check console for details."
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleDelete = async (linkId) => {
    if (
      !window.confirm(
        "Are you sure you want to delete this link and all its assignments?"
      )
    )
      return;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Share and manage links with your team
          </p>
        </div>
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
                ...
                <p className="text-gray-600 text-base">
                  Start sharing links with your team members
                </p>
              </div>
            )}
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      value={li.linkType}
                      onChange={(e) =>
                        handleChange(idx, "linkType", e.target.value)
                      }
                    >
                      <option value="">Select type</option>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={li.country}
                      onChange={(e) =>
                        handleChange(idx, "country", e.target.value)
                      }
                    />
                  </div>
                </div>
